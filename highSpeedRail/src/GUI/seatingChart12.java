...
public class seatingChart12 {
 ...
 private JButton prevTrain,a11,b11,c11,d11,e11,a12,b12,c12,d12,e12,a13,b13,c13,d13,e13,a14,b14,c14,d14,e14;
 
 public seatingChart12() {
	 frame=new JFrame("12號車座位表");
	 /*
	  * 建立一個名為"二號車座位表"的JFrame
	  * 內有72個JButton
	  */
	 p0=new JPanel();
	 p0.add(new JLabel("標準車廂(共68席)"));
	 ...
	 p4=new JPanel();
	 prevTrain=new JButton(" ← 往11號車");
	 p4.add(prevTrain);
	 prevTrain.addActionListener( new ActionListener() {
	        public void actionPerformed(ActionEvent ev) {
	         seatingChart11 n=new seatingChart11();	//進入"11號車座位表"介面
