...
public class seatingChart10 {
 ...
 public seatingChart10() {
	 frame=new JFrame("10號車座位表");
	 /*
	  * 建立一個名為"10號車座位表"的JFrame
	  * 內有103個JButton
	  */
	 p0=new JPanel();
	 ...
	 p4=new JPanel();
	 prevTrain=new JButton(" ← 往9號車");
	 p4.add(prevTrain);
	 prevTrain.addActionListener( new ActionListener() {
	        public void actionPerformed(ActionEvent ev) {
	         seatingChart9 n=new seatingChart9();	//進入"9號車座位表"介面
	         frame.setVisible(false);
	        }
	      });
	 nextTrain=new JButton(" → 往11號車");
	 p4.add(nextTrain);
