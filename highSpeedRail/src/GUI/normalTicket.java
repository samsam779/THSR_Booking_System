...
public class normalTicket {
 ...
 public normalTicket(String uid) {
  ...
  nextStep.addActionListener( new ActionListener() {
	        public void actionPerformed(ActionEvent ev) {
	         ...
	         //根據選擇"單程"或"來回"分別進入不同介面
	        	 ...
	        	 normalTicket1 n=new normalTicket1(START,DESTINATION,CARTYPE,SEATTYPE,TICKETTYPE,uid);
		         frame.setVisible(false);	
	         }
	         else if(i==1) {
	        	 normalTicket2 n=new normalTicket2(START,DESTINATION,CARTYPE,SEATTYPE,TICKETTYPE,uid);
		         frame.setVisible(false);
	         }
