...
public class seatingChart11 {
 ...
 public seatingChart11() {
	 frame=new JFrame("11號車座位表");
	 /*
	  * 建立一個名為"二號車座位表"的JFrame
	  * 內有93個JButton
	  */
	 p0=new JPanel();
	 ...
	 p4=new JPanel();
	 prevTrain=new JButton(" ← 往10號車");
	 p4.add(prevTrain);
	 prevTrain.addActionListener( new ActionListener() {
	        public void actionPerformed(ActionEvent ev) {
	         seatingChart10 n=new seatingChart10();	//進入"10號車座位表"介面
	         frame.setVisible(false);
	        }
	      });
	 nextTrain=new JButton(" → 往12號車");
	 p4.add(nextTrain);
	 nextTrain.addActionListener( new ActionListener() {
	        public void actionPerformed(ActionEvent ev) {
	         seatingChart12 n=new seatingChart12();	//進入"12號車座位表"介面
	         frame.setVisible(false);
	        }
	      });
