...
public class earlyTicket1 {
	...
	public earlyTicket1(String START, String DESTINATION, String CARTYPE, String SEATTYPE, String TICKETTYPE,
			String uid) {
		this.START = START;
		...
		/*
		 * 建立一個名為"早鳥購票"的JFrame(單程購票) 內有兩個JButton 五個JComboBox 兩個JTextField
		 */
		...
		lastStep.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				...
				earlyTicket.frame.setVisible(true); // 回到"早鳥購票"介面
