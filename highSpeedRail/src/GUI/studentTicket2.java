...
public class studentTicket2 {
	...
	public studentTicket2(String START, String DESTINATION, String CARTYPE, String SEATTYPE, String TICKETTYPE,
			String uid) {
		this.START = START;
		...
		/*
		 * 建立一個名為"學生購票"的JFrame(來回購票) 內有兩個JButton 六個JComboBox 四個JTextField
		 */
		p0 = new JPanel();
		...
		lastStep.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				...
				normalTicket.frame.setVisible(true); // 回到"學生購票"介面
												...
												if(diff>0&&dayDiff<28) {//如果日期不是未來28天內則不予訂票
													try {
														testticket t = new testticket(START, DESTINATION, CARTYPE, SEATTYPE,
																TICKETTYPE, uid, normalN, goDate, backDate, "student");
