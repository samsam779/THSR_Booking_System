...
public class studentTicket {
 ...
 public studentTicket(String uid) {
  ...
  nextStep.addActionListener( new ActionListener() {
	        public void actionPerformed(ActionEvent ev) {
	         ...
	         //根據選擇"單程"或"來回"分別進入不同介面
	        	 ...
	        	 studentTicket1 n=new studentTicket1(START,DESTINATION,CARTYPE,SEATTYPE,TICKETTYPE,uid);
		         frame.setVisible(false);
	         }
	         else if(i==1) {
	        	 studentTicket2 n=new studentTicket2(START,DESTINATION,CARTYPE,SEATTYPE,TICKETTYPE,uid);
		         frame.setVisible(false);
	         }
	        }
	      });
